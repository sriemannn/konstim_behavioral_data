`simulation.py` reads the in `simulation_parameters.csv` extracted stimulation parameter and creates SimNIBS simulations for the extracted data (i.e., **Figure 1**).
